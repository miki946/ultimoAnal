...
public class Settings {
	...
	public static Settings shots(String newLeague) {
		float v0=0f, v1=0.55f, v2=0.5f, v3=1f;
		return new Settings(newLeague, v0, v0, v0, v1, v1, v1, v2, v0).withShots(v3);
	}

	public static Settings basic(String newLeague) {
		float v0=0f, v1=0.55f, v2=0.5f, v3=1f;
		return new Settings(newLeague, v3, v0, v0, v1, v1, v1, v2, v0);
	}

	public static Settings poisson(String newLeague) {
		float v0=0f, v1=0.55f, v2=0.5f, v3=1f;
		return new Settings(newLeague, v0, v3, v0, v1, v1, v1, v2, v0);
	}

	public static Settings weightedPoisson(String newLeague) {
		float v0=0f, v1=0.55f, v2=0.5f, v3=1f;
		return new Settings(newLeague, v0, v0, v3, v1,v1, v1, v2, v0);
	}

	public static Settings halfTime(String newLeague, float overOne) {
		float v0=0f, v1=0.55f, v2=0.5f, v3=1f;
		return new Settings(newLeague, v0, v0, v0, v1, v1, v1, v2, v0).withHT(overOne, v3);
	}
	...
	public String toString() {
		...
		return league + " bas*" + format(basic) + " poi*" + format(poisson) + " wei*" + format(weightedPoisson) + " ht*"
				...
				+ format(threshold) /*
									 ...
									 */ + " value " + format(value) + String.format(" %.2f%% ", successRate * v100)
				+ format(profit);
