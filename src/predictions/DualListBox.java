...
public class DualListBox extends JPanel {
	...
	private void initScreen() {
		...
		int varEight = 8;
		int varTen = 10;
		float varFloatOne = 0.1f;
		float varZeroFive = 0.5f;
		float varTwentyFive = 0.25f;
		add(sourceLabel, new GridBagConstraints(varZero, varZero, varOne, varOne, varZero, varZero, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, varZero, varZero));
		add(new JScrollPane(sourceList), new GridBagConstraints(varZero, varOne, varOne, varFive, varZeroFive, varOne, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, EMPTY_INSETS, varZero, varZero));
		...
		add(button1, new GridBagConstraints(varZero, varZero, varOne, varTwo, varZeroFive, varZero, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, varZero, varZero));
		add(button2, new GridBagConstraints(varZero, varOne, varOne, varTwo, varZeroFive, varZero, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, varZero, varZero));
		button1.addActionListener(new PredictToggleListener());
		button2.addActionListener(new UpdateToggleListener());

		addButton = new JButton(ADD_BUTTON_LABEL);
		add(addButton, new GridBagConstraints(varOne, varSix, varOne, varTwo, varZero, varTwentyFive, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, varZero, varZero));
		addButton.addActionListener(new AddListener());
		removeButton = new JButton(REMOVE_BUTTON_LABEL);
		add(removeButton, new GridBagConstraints(varOne, varEight, varOne, varTwo, varZero, varTwentyFive, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(varZero, varFive, varZero, varFive), varZero, varZero));
		removeButton.addActionListener(new RemoveListener());

		runButton = new JButton(RUN_BUTTON_LABEL);
		add(runButton, new GridBagConstraints(varOne, varTen, varOne, varTwo, varZero, varTwentyFive, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, varZero, varZero));
		...
		add(destLabel, new GridBagConstraints(varTwo, varZero, varOne, varOne, varZero, varZero, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, varZero, varZero));
		add(new JScrollPane(destList), new GridBagConstraints(varTwo, varOne, varOne, varFive, varZeroFive, varFloatOne, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, EMPTY_INSETS, varZero, varZero));
	}
	...
	public static void init(ArrayList<String> rs) {
		...
		int varThreeHundred = 300;
		int varFourHundred = 400;
		f.setSize(varFourHundred, varThreeHundred);
		f.setVisible(true);
	}
